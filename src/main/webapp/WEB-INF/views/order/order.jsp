            ...
            <form>
                    <table class="cart__list">
                            ...
                            <tr class="cart__list__detail">
                                <td><input type="checkbox" name="check" data-cat="<%=nowDto.getPrice()%>" value="<%=nowDto.getProductId()%>"></td>
                                ...
                                <td class="cart__list__option">
                                    <input type="number" id="<%=nowDto.getProductId()%>" class="cart__list__numberinput" val="<%=nowDto.getQuantity() %>" min="0"  style="width: 100px;">
                                </td>
                        ...
                        <td style="padding: 5px; text-align: right;" colspan="6">
                           <button type="button" id="cart__list__deletebtn" class="cart__list__optionbtn" style="font-size: 13px;">선택상품 삭제</button>
                        </td>
                     </tr>
                            </tbody>
                    </table>
        ...
        <div class="float_right">
            <form>
                <div class="cart__mainbtns payment_right_back" style="font-weight: 100;">
                    ...
                    <button id="" class="cart__bigorderbtn right">주문하기</button>
                </div>
            </form>
        </div>
    </div>
