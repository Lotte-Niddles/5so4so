...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/product/main.css">
<meta name="viewport"
		...
		<div class="productListInner">
			...
			<div class="productWrapper">
				<div class="productImage">
					<a href="productDetail.do?id=<%=dto.getId()%>"> <img alt=""
						src="<%=dto.getthumbnailUrl()%>" width="269" height="269">
					</a>
				</div>
				<div class="productContent">
					<div class="productTitle">
						<a href="productDetail.do?id=<%=dto.getId()%>"
							style="text-decoration: none"> <span class="productName"><%=dto.getName()%></span>
						</a>
					</div>
